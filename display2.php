...
<table id="t2" class="table table-striped table-hover table-bordered">
  <thead>
    <tr>
        <th>ID</th>
        <th>Name</th>
...
<script>
  $('#json').on('click',function(){
    $("#t2").tableHTMLExport({type:'json',filename:'HospitalDatabase.json'});
  })
  $('#csv').on('click',function(){
    $("#t2").tableHTMLExport({type:'csv',filename:'HospitalDatabase.csv'});
  })
  $('#pdf').on('click',function(){
    $("#t2").tableHTMLExport({type:'pdf',filename:'HospitalDatabase.pdf'});
  })
  </script>
</script>
